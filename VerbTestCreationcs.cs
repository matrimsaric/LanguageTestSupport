...
namespace LanguageTestSupport
{
    ...
    public class VerbCreationTests
    {
        ...
        public void BlankIchidanKanji()
        {
            try
            {
                Verb verb = new IchidanVerb(String.Empty, "a", "b", "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void BlankGodanKanji()
        {
            try
            {
                Verb verb = new GodanVerb(String.Empty, "a", "b", "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void BlankIchidanHiraganai()
        {
            try
            {
                Verb verb = new IchidanVerb("a", String.Empty, "b", "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void BlankGodanHiragana()
        {
            try
            {
                Verb verb = new GodanVerb("a", String.Empty, "b", "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void BlankIchidanRomaji()
        {
            try
            {
                Verb verb = new IchidanVerb("a", "a", String.Empty, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void BlankGodanRomaji()
        {
            try
            {
                Verb verb = new GodanVerb("a", "a", String.Empty, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackIchidanKanji()
        {
            try
            {
                Verb verb = new IchidanVerb(hackText, "a", String.Empty, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackIchidanHiragana()
        {
            try
            {
                Verb verb = new IchidanVerb("a", hackText, String.Empty, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackIchidanRomaji()
        {
            try
            {
                Verb verb = new IchidanVerb("a", "a", hackText, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackIchidanMeaning()
        {
            try
            {
                Verb verb = new IchidanVerb("a", "a", "a", hackText, Guid.NewGuid());
        ...
        public void HackGodanKanji()
        {
            try
            {
                Verb verb = new GodanVerb(hackText, "a", String.Empty, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackGodanHiragana()
        {
            try
            {
                Verb verb = new GodanVerb("a", hackText, String.Empty, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackGodanRomaji()
        {
            try
            {
                Verb verb = new GodanVerb("a", "a", hackText, "c", Guid.NewGuid());
            }
            catch
            {
                return;
        ...
        public void HackGodanMeaning()
        {
            try
            {
                Verb verb = new GodanVerb("a", "a", "a", hackText, Guid.NewGuid());
        ...
        public void ValidEntries()
        {
            try
            {
                Verb ichidanVerb = new IchidanVerb("書く", "かく", "Kaku", "To Write",  Guid.NewGuid());
                Verb godanVerb = new GodanVerb("書く", "かく", "Kaku", "To Write", Guid.NewGuid());
